...
const HeroUserImg = () => {
  ...
  return (
    <div className='relative w-fit p-8 overflow-hidden'>
      {/* react Icon */}
      <div ref={reactIconRef} className="absolute rounded-full backdrop-blur p-2 bg-white/80 bottom-10 left-15 h-12 w-12">
        <img
      ...
      {/* node icon */}
      <div ref={nodeIconRef} className="absolute rounded-full backdrop-blur p-2 bg-white/70 top-10 right-15 h-12 w-12">
        <img
          className='object-cover object-fit'
      ...
      {/* figma icon */}
      <div ref={figmaIconRef} className="absolute rounded-full backdrop-blur p-2 bg-white/70 bottom-22 right-15 h-12 w-12 flex justify-center items-center">
        <img
      ...
      {/* github icon */}
      <div ref={gitIconRef} className="absolute rounded-full backdrop-blur p-2 bg-white/70 top-36 left-15 h-12 w-12 flex justify-center items-center">
        <img
          className='h-7 object-cover object-fit'

    ...
    <section id="about" className='min-h-[42rem] py-[5rem] px-3 text-gray-dd'>
      ...
      <div className="grid grid-cols-1 gap-14  lg:grid-cols-2 justify-items-center mt-[4rem]">
        ...
        <div className="p-3 md:p-5 flex flex-col gap-9 items-center lg:items-start">
          {/* badges */}
          <div className="grid grid-cols-3 w-full justify-items-center gap-2 text-l-primary dark:text-d-secondary">
            {/* Experience badge */}
          ...
          <a
            href={CV}
            download=""
            className='w-fit bg-l-primary dark:bg-d-primary text-d-primary dark:text-l-primary font-medium px-4 py-3 md:py-4 rounded-xl text-xl items-center'>Download CV
